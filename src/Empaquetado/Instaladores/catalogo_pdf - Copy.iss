...
OutputDir=Y:\Instaladores\CatalogoPDF
OutputBaseFilename=CatalogoPdfSetup
SetupIconFile=Z:\logoST.ico
Compression=lzma
...
[Files]
Source: "Y:\CatalogoPDF_\redist\*"; DestDir: {tmp}
Source: "Y:\CatalogoPDF_\Windows\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "Y:\CatalogoPDF_\Windows\flutter_windows.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "Y:\CatalogoPDF_\Windows\data\*"; DestDir: "{app}\data"; Flags: ignoreversion recursesubdirs createallsubdirs
